            ...
            <div className="flex flex-col xl:flex-row">
                ...
                <div className="w-full xl:w-1/3 flex flex-col justify-between px-10 border-l pt-4 xl:pt-0">
                    <div className="flex flex-col gap-10">
                        ...
                        <p className="text-left font-light text-xl xl:text-2xl">Colaboramos con varias inmobiliarias en Alicante y les proporcionamos nuestros servicios</p>
                    </div>
                    <p className="text-left font-extralight text-2xl xl:text-5xl max-w-[440px] pt-5 xl:pt-0">Contacta con nosotros y te informaremos</p>
                </div>
            </div>
        </div>
    )
