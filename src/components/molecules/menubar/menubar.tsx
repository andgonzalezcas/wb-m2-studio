...
const Menubar = ({ isDark }: props) => {
    return (
        <div className={`h-screen w-fit fixed top-0 right-0 hidden xl:flex flex-col justify-between items-center border-l bg-opacity-0 text-white font-normal p-5 transition-colors duration-300 ${isDark ? "border-[#232C33]/40" : "border-white/40"}`}>
